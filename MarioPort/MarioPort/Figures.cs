...
//      }
      ...
      private void Mirror(ref Bitmap from, ref Bitmap to)
      {
//        type
...
//      }
      ...
      private void Rotate(ref Bitmap from, ref Bitmap to)
      {
//      {
//        asm
//            push    ds
...
//      }
      ...
      private void InitSky(byte NewSky)
      {
//      {
//        Sky = NewSky;
//      }
...
//      }
      ...
      private void InitWalls(byte W1, byte W2, byte W3)
      {
         InitWall(1, W1);
         InitWall(2, W2);
         InitWall(3, W3);
      ...
      private void InitWall(byte N, byte WallType)
      {
         switch (WallType)
         {
            case 0:
...
//      }
      ...
      private void DrawSky(int X, int Y, int W, int H)
      {
//      const
//        Y1 = 0;
//        Y2 = Y1 + 96;
